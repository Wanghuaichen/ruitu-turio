...
#define KEY1_IN_Pin            GPIO_Pin_0
#define KEY1_IN_GPIO_Port      GPIOB
#define KEY2_IN_Pin            GPIO_Pin_1
#define KEY2_IN_GPIO_Port      GPIOB
#define LED_OAS_Pin            GPIO_Pin_12
#define LED_OAS_GPIO_Port      GPIOB
...
#define MOTOR_HOMING_Pin       GPIO_Pin_9
#define MOTOR_HOMING_GPIO_Port GPIOC
